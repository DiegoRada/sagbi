...
urlpatterns = patterns('',
	...
	url(r'^modificar-estatus-pais/(?P<pais_id>[0-9]+)/$', 'apps.sagbi.views.modificar_estatus_pais', name="modificar_estatus_pais"),
	url(r'^modificar-director/(?P<director_id>[0-9]+)/$', 'apps.sagbi.views.modificar_director', name="modificar_director"),
	url(r'^modificar-estatus-director/(?P<director_id>[0-9]+)/$', 'apps.sagbi.views.modificar_estatus_director', name="modificar_estatus_director"),
	...
	url(r'^modificar-estatus-autor/(?P<autor_id>[0-9]+)/$', 'apps.sagbi.views.modificar_estatus_autor', name="modificar_estatus_autor"),
	...
	url(r'^modificar-estatus-pelicula/(?P<pelicula_id>[0-9]+)/$', 'apps.sagbi.views.modificar_estatus_pelicula', name="modificar_estatus_pelicula"),
	...
	url(r'^modificar-estatus-libro/(?P<libro_id>[0-9]+)/$', 'apps.sagbi.views.modificar_estatus_libro', name="modificar_estatus_libro"),
